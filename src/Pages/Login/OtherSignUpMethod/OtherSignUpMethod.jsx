...
const OtherSignUpMethod = () => {
    const { loading, setLoading, provideSignInWithGoogle, provideSignInWithGitHub, provideSignInWithFaceBook } = useContext(AuthContext);
    ...
    return (
        <div className='mt-5'>
            <p className='text-center  m' >Or sign up with</p>

            <div className='w-full flex  justify-center items-center mt-5'>


                {/* fb  */}
                <button className='border-2 rounded-3xl p-2 border-[#444] mx-5 ' onClick={handleFaceBookLogin}>
                ...
                {/* google  */}
                <button className='border-2 rounded-3xl p-2 border-[#444] mx-5 ' onClick={handleGoogleLogin}>
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                ...
                {/* github  */}
                <button className='border-2 rounded-3xl p-2 border-[#444] mx-5 ' onClick={handleGitHubLogin}>
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                        <g clipPath="url(#clip0_3_149)">
...
export default OtherSignUpMethod;